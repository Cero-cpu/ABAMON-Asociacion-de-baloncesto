...
export const actualizarEquipo = (id, data) => api.put(`/api/equipos/${id}`, data)
...
export const actualizarPartido = (id, data) => api.post(`/api/partidos/${id}/manual-update`, data)
...
export const getRachas = () => api.get('/api/stats/rachas')
